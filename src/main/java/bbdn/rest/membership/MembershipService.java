...
public class MembershipService {
	 ...
	 */
	public List<Membership> readAllByCourseId(String crsId, boolean expand) {
		log.info("READALL");

		String endpoint = RestConstants.MEMBERSHIP_BASE_PATH + "/" + crsId + "/users";

		if (expand) {
			endpoint += "?expand=user";
		}
	...
	public List<Membership> readAllByUserId(String userId, boolean expand) {
		log.info("READALL");

		String endpoint = RestConstants.USER_PATH + "/" + userId + "/courses";

		if(expand) {
			endpoint += "?expand=course";
		}
